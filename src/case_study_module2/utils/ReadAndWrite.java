...
public class ReadAndWrite {
    private static final String CUSTOMER_FILE="src\\case_study_module2\\data\\customer.csv";
    ...
    public static List<Room> readRoomListFromCSV(){
        ...
        for (String string: stringList) {
            arr= string.split(",");
            Room room = new Room(arr[0],Double.parseDouble(arr[2]),Double.parseDouble(arr[3]),Integer.parseInt(arr[4]),arr[5],arr[6]);
            roomList.add(room);
        }
        return roomList;
    }
