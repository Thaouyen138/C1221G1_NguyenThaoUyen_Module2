package dien_thoai.services.impl;
...
import dien_thoai.models.AuthPhone;
import dien_thoai.models.HandPhone;
import dien_thoai.models.Phone;
import dien_thoai.services.IService;
import dien_thoai.utils.NotFoundProductException;
import dien_thoai.utils.ReadAndWriteFiles;
...
public class PhoneServiceImpl implements IService {
    ...
    static {
        authPhoneList = ReadAndWriteFiles.readAuthPhonesListFromCSV("src\\dien_thoai\\data\\authphone.csv");
        handPhoneList = ReadAndWriteFiles.readHandPhonesListFromCSV("src\\dien_thoai\\data\\handphone.csv");
    }
